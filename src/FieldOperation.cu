...
__device__ real ducros_sensor(const DZone *zone, real eps, int i, int j, int k) {
...
__device__ real jameson_sensor(const DZone *zone, int i, int j, int k) {
...
__device__ real density_pressure_jump_sensor(const DZone *zone, real eps, int i, int j, int k) {
